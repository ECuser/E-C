...
def calculate_uplift(promo_entries, baseline):
    ...
    for entry in promo_entries:
        ...
        diff_units   = round(total_actual - expected, 1) if missing_act == 0 and missing_fc == 0 else None
        uplift_units = round(total_actual - total_forecast, 1) if missing_act == 0 and missing_fc == 0 else None
